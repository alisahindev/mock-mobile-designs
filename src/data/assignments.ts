...
export const mockAssignments: Assignment[] = [
  {
    ...
    detail: {
      setting: "You're at a cozy neighborhood cafe. It's a Saturday morning, and you want to order a coffee and maybe a snack. The barista is friendly and ready to help you.",
      studentRole: {
        name: 'Customer',
      ...
      aiRole: {
        name: 'Barista',
        description: 'I am a friendly barista working at the cafe. I will help you order and answer any questions about our menu.'
      },
      helpfulPhrases: [
        {
          id: 'phrase-1',
  ...
  },
  {
    ...
    detail: {
      setting: "You need to see a doctor because you haven't been feeling well. You're calling the clinic to make an appointment.",
      studentRole: {
        name: 'Patient',
      ...
      aiRole: {
        name: 'Receptionist',
        description: 'I am the clinic receptionist. I will help you schedule an appointment and gather necessary information.'
      },
      helpfulPhrases: [
        {
          id: 'phrase-6',
  ...
  },
  {
    ...
    detail: {
      setting: "You're at a clothing store looking for a new jacket. You want to find the right size and color, and you'd like to try it on before buying.",
      studentRole: {
        name: 'Shopper',
  ...
  },
  {
    ...
    detail: {
      setting: "You're at a nice restaurant for dinner. You've just been seated and are ready to look at the menu and order your meal.",
      studentRole: {
        name: 'Diner',
